...
<html lang="en">
  ...
  <body>
    ...
    <main id="main">
      ...
      <!-- ======= Suggestion Section ======= -->
      <section id="suggestion" class="suggestion">
        <div class="container" data-aos="fade-up">
          <div class="section-title">
            <h2>MIFILM berterimakasih jika visiters bersedia untuk membagikan informasi film-film.</h2>
            <p>Terbuka untuk Saran Film</p>
          </div>
          ...
          <form method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
                <input type="text" class="form-control" name="phone" id="phone" placeholder="Nomor telephone" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                <div class="validate"></div>
              </div>
            </div>
            <div class="form-group mt-3">
              <textarea class="form-control" name="message" rows="5" placeholder="Ketikkan informasi mengenai film baik judul dan lain-lain."></textarea>
              <div class="validate"></div>
            </div>
            <div class="mb-3">
